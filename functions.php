 ...
 */
 ...
 function mc_sigma_block_assets(){
    ...
    wp_enqueue_style( 'mc-sigma-style', get_stylesheet_directory_uri() . '/style.css', array(), wp_get_theme()->get( 'Version' ) );
	...
	wp_enqueue_script('mc-sigma-main-script', get_stylesheet_directory_uri() . '/assets/js/script.js', array('jquery'), '1.0.0', true);
}

// add_action('init', 'mc_sigma_block_assets');
