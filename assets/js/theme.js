(function (global, factory) {
	...
	var jquerySticky = { exports: {} };

	var hasRequiredJquerySticky;

	function requireJquerySticky() {
		if (hasRequiredJquerySticky) return jquerySticky.exports;
		hasRequiredJquerySticky = 1;
		(function (module) {
					...
					scroller = function scroller() {
						...
						for (var i = 0, l = sticked.length; i < l; i++) {
							...
							if (scrollTop <= etse) {
								...
								var stickyWrapperContainer =
									s.stickyWrapper.parent();
								var unstick =
					...
					methods = {
						...
						unstick: function unstick(options) {
							return this.each(function () {
								...
								while (i-- > 0) {
									if (
										sticked[i].stickyElement.get(0) === that
									) {
