...
<div class="wp-block-group alignwide" id="sticky-header"
    style="border-bottom-color:#8e8e8e;border-bottom-width:1px;margin-top:0;margin-bottom:0;padding-top:20px;padding-right:var(--wp--preset--spacing--40);padding-bottom:20px;padding-left:var(--wp--preset--spacing--40)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-group">
            ...
            <!-- wp:navigation {"ref":335,"style":{"layout":{"selfStretch":"fit","flexSize":null}},"fontFamily":"body"} /-->
        </div>
        <!-- /wp:group -->

        <!-- wp:buttons {"className":"sigma-header-button"} -->
        <div class="wp-block-buttons sigma-header-button"><!-- wp:button -->
            <div class="wp-block-button"><a class="wp-block-button__link wp-element-button">Sazinieties ar mums</a>
            </div>
            <!-- /wp:button -->
        </div>
        <!-- /wp:buttons -->
